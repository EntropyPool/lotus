...
var eResourceTable = map[sealtasks.TaskType]map[abi.RegisteredSealProof]*eResources{
	...
	sealtasks.TTCommit2: {
		abi.RegisteredSealProof_StackedDrg64GiBV1:  &eResources{Memory: 580 * eGiB, CPUs: 0, GPUs: 1, DiskSpace: 512 * eMiB},
		abi.RegisteredSealProof_StackedDrg32GiBV1:  &eResources{Memory: 290 * eGiB, CPUs: 0, GPUs: 1, DiskSpace: 512 * eMiB},
